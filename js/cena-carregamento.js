export default class CenaCarregamento extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.on("progress", (value) => {
      ...
      // espaço preto interno
      barraDeProgresso.lineStyle(8, 0x000000, 1);
    ...
    this.load.image("slimeball", "../images/slimeball.png");
    this.load.image("bomba", "../images/bomb.png");
    this.load.spritesheet("slime", "images/slime-vermelha.png", {
      frameWidth: 24,
      frameHeight: 24,
    });
  }
